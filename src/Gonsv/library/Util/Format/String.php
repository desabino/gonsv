...
class Util_Format_String extends Util_Format_Abstract
{
	...
	/**
	 * Inclui caracteres a esquerda até uma determinada quantidade.
	 *
	 * @param string $string String a ser formatada.
	 * @param int    $qtd    Quantidade de caracteres que a string deve ter.
	 * @param string $char   Caracter(es) de substituíção.
	 *
	 * @return string
	 */
	static public function LeftChar($string, $qtd, $char = '.')
	{
		return (string)str_pad($string, $qtd, $char, STR_PAD_LEFT);
	}

	/**
	 * Inclui caracteres a direita até uma determinada quantidade.
	 *
	 * @param string $string String a ser formatada.
	 * @param int    $qtd    Quantidade de caracteres que a string deve ter.
	 * @param string $char   Caracter(es) de substituíção.
	 ...
	 * @return string
	 */
	static public function RightChar($string, $qtd, $char = '.')
	{
		return (string)str_pad($string, $qtd, $char, STR_PAD_RIGHT);
	}
	...
	/**
	 * Substitui qualquer quantidade de espaços entre as strings por apenas um.
	 *
	 * @param string $string String a ser formatada.
	 * @return string
	 */
    ...
    static public function ClearMaskChars($string)
    {
    	$chars = array(
    		'('  => '',
    		')'  => '',
